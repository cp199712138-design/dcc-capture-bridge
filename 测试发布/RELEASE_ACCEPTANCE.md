...
如果 `browser-smoke` 因 Chrome/Edge、CDP、websocket 或 headless 环境失败，记录原始错误；不要修改 UI/API/Canvas 代码来绕过环境问题。
...
- PR 描述包含：启动地址、mock 默认不耗额度、OpenAI/Custom 选择方式、已跑验证命令、冻结范围。
