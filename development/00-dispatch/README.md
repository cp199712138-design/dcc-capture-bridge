...
| `04 3ds Max` | Frozen this round; keep existing files only | `3ds Max`, `development/04-dcc-adapters`, `src`, `dist` |
| `05 Blender` | Frozen this round; no new adapter implementation | `Blender`, `development/04-dcc-adapters` |
...
- 3ds Max and Blender are frozen for this repair round. Do not add implementation there unless a release/security check proves the current files block browser delivery.
